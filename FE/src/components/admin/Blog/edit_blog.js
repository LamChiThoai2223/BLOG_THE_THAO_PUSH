...
const BlogEdit = () => {
  ...
  useEffect(() => {
    ...
    const getTagsList = async () => {
      try {
        const tags = await fetchAll(apiUrl, 1, setTagsList, setError);
        if (tags && tags.data) {
  ...
  const handleEditorChange = (editorState) => {
    ...
    const plainText = rawContentState.blocks
      ...
      .join(" ");
    setValue("context", plainText); // Cập nhật context
  };
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success(`Success: Update Blog successfully.`, {
  ...
  useEffect(() => {
    ...
    fetchAll(apiUrl, 1, setTagsData, setError); // Fetch all tags
        ...
        <div className="app-content pt-3 p-md-3 p-lg-4">
          <div className="container-xl card">
            <div className="card-body">
              <h1 className="app-page-title">Edit Blog</h1>
              <hr className="mb-4" />
