                                    ...
                                    <div className="app-card app-card-settings shadow-sm p-4">
                                        <div className="app-card-body">
                                            <form className="settings-form" onSubmit={handleSubmit(onSubmit)}>
                                                <div className="mb-3">
                                                    <label htmlFor="post-title" className="form-label">Blog Name <span className="text-danger">*</span></label>
                                                    <input
                                                        type="text"
                                                        ...
                                                        {...register("title", {
                                                            ...
                                                            minLength: { value: 5, message: "Blog Name must be at least 5 characters" }
                                                        })}
                                                    />
                                                ...
                                                <div className="mb-3">
                                                    <label htmlFor="post-image" className="form-label">Blog Image</label>
                                                    <input
                                                        type="file"
                                                        className="form-control"
                                                        id="image"
                                                    ...
                                                    {imageUrl && (
                                                        <div className="mt-3">
                                                            <img src={imageUrl} alt="Preview" style={{ width: '100%', maxWidth: '200px' }} />
                                                        </div>
                                                    )}
                                                     {imageError && (
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    >
                                                        ...
                                                        {categoriesData.filter(cate => !cate.is_delete).map((cate) => (
                                                            <option key={cate.category_id} value={cate.category_id}>{cate.name}</option>
                                                        ))}
                                                    </select>
                                                ...
                                                <div className="mb-3">
                                                    <label htmlFor="sport_id" className="form-label">Sport <span className="text-danger">*</span></label>
                                                    <select
                                                        className="form-control p-2"
                                                        id="sport_id"
                                                        {...register("sport_id", {
                                                            required: { value: true, message: "Sport is required" }
                                                        })}
                                                    >
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <Controller
                                                        ...
                                                        defaultValue={[]}
                                                        render={({ field }) => (
                                                            <TagInput value={field.value} onChange={field.onChange} tagsList={tagsData} />
                                                        )}
                                                    />
                                                </div>
                                                <div className="mb-3">
                                                    <label htmlFor="post-content" className="form-label">Content <span className="text-danger">*</span></label>
                                                    <Controller
                                                        name="content"
                                                        control={control}
                                                        defaultValue=""
                                                        render={({ field }) => (
                                                            <TextEditor editorState={editorContent} onChange={handleEditorChange} onHTMLChange={handleHTMLChange} />
                                                        )}
                                                    />
                                                ...
                                                <button type="submit" className="btn" style={{background: 'green', color: 'white'}}>ADD</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
