...
import { fetchBlogsByCategory } from "../../../services/Blog";
...
const BlogCategory = () => {
  ...
  useEffect(() => {
    fetchBlogsByCategory(id, setBlogData, setError);
  }, [id]);
          ...
          <div className="row">
            <div className="col-12">
              ...
              <h1 className="mb-4 border-bottom border-primary d-inline-block">
                Blogs by Category: {currentCategory || "Loading..."}
              </h1>
              <Helmet>
                <title>{currentCategory || "Not found"}</title>
              </Helmet>
            </div>
