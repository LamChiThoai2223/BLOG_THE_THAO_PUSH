...
import { fetchBlogsBySport } from "../../../services/Blog"; // Sử dụng API phù hợp
import { fetchSportDetails, fetchSports } from "../../../services/Sports";
...
const BlogBySport = () => {
  ...
  useEffect(() => {
    fetchBlogsBySport(id, setBlogData, setError);
  }, [id]);
          ...
          <div className="row">
            <div className="col-12">
              ...
              <h1 className="mb-4 border-bottom border-primary d-inline-block">
                Blogs by Sport: {currentSport || "Loading..."}
              </h1>
              <Helmet>
                <title>{currentSport || "Not found"}</title>
              </Helmet>
            </div>
