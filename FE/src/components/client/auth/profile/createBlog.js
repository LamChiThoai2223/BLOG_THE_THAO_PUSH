      ...
      <div className="author-client user-profile">
        <div className="row">
          ...
          <div className="col-md-8 backG-proflie">
            <span className="profile-info-author-title">Create Blog</span>
                  ...
                  <div className="app-card app-card-settings p-4">
                    <div className="app-card-body">
                      <form className="settings-form" onSubmit={handleSubmit(onSubmit)}>
                        {/* Blog Name và Short Description nằm cùng một hàng */}
                        ...
                        {/* Category và Sport nằm cùng một hàng */}
                        <div className="row mb-3">
                          <div className="col-12 col-md-6">
